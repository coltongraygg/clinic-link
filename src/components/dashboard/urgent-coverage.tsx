...
export default function UrgentCoverageSection({
  urgentSessions,
}: UrgentCoverageSectionProps) {
  ...
  const SessionCard = ({
    ...
    <div
      className={`rounded-lg border p-4 ${isCritical ? "border-red-200 bg-red-50" : "border-orange-200 bg-orange-50"}`}
    >
